...
// NOTE: the home hero already makes the "built the growth engine" claim —
// this profile copy deliberately tells the person/story instead, so the two
// sections never repeat each other.
