...
// systems marketing to customers across 150+ markets. Update as talks evolve.
...
export const speakingTopics = [
  {
    ...
    outcomes: [
      ...
      "How to get your engineers and your marketing team building one system together",
    ],
  },
  {
    title: "AI Localization at Scale: Doubling Output Without Doubling Headcount",
    description:
      "The human-in-the-loop system that shipped content to customers across 150+ markets faster, without the brand voice collapsing into generic, forgettable output.",
    outcomes: [
      "The QA layer that keeps AI-localized content from sounding translated",
      "How brand glossaries prevent 150 markets from sounding like 150 different companies",
...
export const mediaFeatures = ["Bloomberg", "CNBC", "MediaCorp", "SPH", "Discovery"];
