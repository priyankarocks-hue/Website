// Central integration config. These are the only two values to change
// when the real accounts exist; every embed and button reads from here.
...
// enquiries to the contact form instead.
